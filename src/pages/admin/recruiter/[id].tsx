...
import { Globe, Instagram, Linkedin, Twitter, UserCircle2 } from "lucide-react";
import Head from "next/head";
import { useRouter } from "next/router";
import { DeleteRecruiter } from "~/components/admin";
import { PageHeader, Spinner } from "~/components/ui";
import AdminLayout from "~/layouts/admin-layout";
import { api } from "~/utils/api";

export default function RecruierProfile() {
  const { query } = useRouter();
  const { data: recruter } = api.recruiterAdmin.getRecruterProfile.useQuery({
        ...
        <div className="container">
          ...
          <div className="container">
            ...
            <div className="container card rounded-box grid flex-grow border border-red-600 bg-base-300 py-7">
              <DeleteRecruiter id={recruter.id} />
            </div>
          </div>
        </div>
      </AdminLayout>
